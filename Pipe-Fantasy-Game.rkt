...
;; Uncomment the last line of code to see the example run
...
(check-expect (my-member? (list 3 4) (list (list 1 2) (list 3 4) (list 3 3))) #true)
(check-expect (my-member? (list 5 5) (list (list 1 2) (list 3 4) (list 3 3))) #false)
...
;; pipe-image: pipe Number Number boolean gooflow integer integer -> image
...
(define game-test (make-gamestate
 (make-grid
  6
  (list   (list 1 1 (make-pipe #false #false #false #true))   (list 1 2 (make-pipe #false #true #false #true))   (list 1 3 (make-pipe #true #true #true #true))   (list 1 4 (make-pipe #true #false #false #true))
   (list 2 1 (make-pipe #false #true #true #false))   (list 2 2 (make-pipe #true #true #true #true))   (list 2 3 (make-pipe #true #true #false #false))   (list 2 4 (make-pipe #true #false #true #false))
   (list 3 2 (make-pipe #false #false #true #true))   (list 4 2 (make-pipe #true #false #true #false))))
 (list (list 1 1 "right"))
 (list (make-pipe #false #true #false #true) (make-pipe #true #true #false #false) (make-pipe #false #false #true #true) (make-pipe #true #true #true #true) (make-pipe #true #false #true #false))
 100 30 0 140))
...
(check-expect (take-first-n-fill-blanks (list 1 2 3 4) 2 5) (list 1 2))
(check-expect (take-first-n-fill-blanks '() 2 5) (list 5 5))
  ...
  (local
    [(define incoming-pipes (gamestate-incoming-pipes gs))
     ...
     (define incoming-pipes-img
       (above
        (text (string-append "SCORE\n" (number->string (get-score gs))) 40 "Green")
        (foldr
         (lambda (pipe img)
...
; returns a score based on the length of the goo path
(check-expect (get-score game-test) 0)
...
; propoagates the goo based on ticks
(check-expect (next-goo game-test)
              (make-gamestate
               (make-grid
                6
                (list
